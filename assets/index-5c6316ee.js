const e=`import { PropsType, defineExpose, h, onMounted, ref, watch, RefImpl, isRef, ClassNameType, StyleType } from "pl-vue"
...
export default function(props: UnfoldTextProps) {
  ...
  return <div ref={wrapRef} className={['br-unfold-text', ...[props.className].flat()]} style={props.style}>
    {() => origin.value
      ? <div>{() => model.value}</div>
